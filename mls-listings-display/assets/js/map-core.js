...
const MLD_Map_App = {
    ...
    /**
     * Initializes the map instance (Google Maps or Mapbox).
     */
    async initMap() {
        const mapContainer = document.getElementById('bme-map-container');
        if (bmeMapData.provider === 'google') {
            ...
            this.map = new mapboxgl.Map({ container: 'bme-map-container', style: 'mapbox://styles/mapbox/streets-v11', center: [-71.0589, 42.3601], zoom: 10 });
